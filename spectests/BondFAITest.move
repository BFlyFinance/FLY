...
script {
    ...
    fun init_bond_stake(signer: signer) {
        ...
        Config::update_bond_config<FAI::FAI>(&signer, 2500, 1u128, 10000000000u128, 1000000000000000000u128, 10000000000000u128, 432000u128);
...
script {
    ...
    fun deposit_stc_bond(signer: signer) {
        Bond::deposit<FAI::FAI>(&signer, 1000000000u128, 1000000000000000000u128);
        let bond_price = Bond::bond_price<FAI::FAI>();
